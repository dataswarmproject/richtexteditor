import type { TextType } from '@digitaltrendz/core'
...
import { Mark, Node } from '@digitaltrendz/pm/model'
import { renderJSONContentToString, serializeChildrenToHTMLString } from '@digitaltrendz/static-renderer/json/html-string'
import { renderToHTMLString } from '@digitaltrendz/static-renderer/pm/html-string'
