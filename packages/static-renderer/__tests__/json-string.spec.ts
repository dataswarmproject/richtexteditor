import type { TextType } from '@inkflow/core'
...
import { Mark, Node } from '@inkflow/pm/model'
import { renderJSONContentToString, serializeChildrenToHTMLString } from '@inkflow/static-renderer/json/html-string'
import { renderToHTMLString } from '@inkflow/static-renderer/pm/html-string'
