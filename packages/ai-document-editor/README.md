# @digitaltrendz/ai-document-editor
...
# or
pnpm add @digitaltrendz/ai-document-editor
# or
yarn add @digitaltrendz/ai-document-editor
```
...
```tsx
import { useAIDocumentEditor, EditorContent } from '@digitaltrendz/ai-document-editor'
...
```tsx
import type { AITool } from '@digitaltrendz/extension-ai-assistant'
...
const AIDocumentEditor = dynamic(
  () => import('@digitaltrendz/ai-document-editor').then(mod => mod.AIDocumentEditor),
  { ssr: false }
)
