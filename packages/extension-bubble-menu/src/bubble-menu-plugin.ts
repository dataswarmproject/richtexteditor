...
import { isTextSelection, posToDOMRect } from '@digitaltrendz/core'
import type { EditorState, PluginView, Transaction } from '@digitaltrendz/pm/state'
import { NodeSelection, Plugin, PluginKey } from '@digitaltrendz/pm/state'
